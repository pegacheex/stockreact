...
import StoKCeL_H_1 from "./Images/StoKCeL_H_1.png"; // Updated logo image
              ...
              <div className="col-sm-3 col-6 footer-section-1">
                <div className="footer-design">
                  <a className="footer-brand" href={this.state.url}>
                    <img
                      src={StoKCeL_H_1} // Updated logo
                      alt="StoKCeL" // Updated alt text
                  ...
                  <ul>
                    ...
                    <li className="footer-item">
                      <h4>
                        ...
                        2021 - StoKCeL {/* Updated copyright */}
                      </h4>
                    </li>
                    <li className="footer-item">
